...
public class XmlParser2 {
    ...
    public XmlParser2(FragmentActivity context){
        int resourceId = context.getResources().getIdentifier("tour", "raw", context.getPackageName());
    ...
    public void parseTrack(FragmentActivity context, Tour t){
        int resourceId = context.getResources().getIdentifier("track_" + t.trkid, "raw", context.getPackageName());
        InputStream inputStreamTrack = context.getResources().openRawResource(resourceId);
